...
CREATE TABLE public.employees (
    ...
    titleofcourtesy character varying(15),
...
--
-- Name: order_details_order_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: order_details_order_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: order_details_product_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: order_details_product_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE SEQUENCE public.products_supplier_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: products_supplier_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.products_supplier_id_seq OWNED BY public.products.supplier_id;
...
CREATE TABLE public.regions (
    ...
    region_description character varying(20)
);
...
--
-- Name: shippers_shipper_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: shippers_shipper_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.suppliers (
    ...
    home_page character varying(250)
);
...
CREATE TABLE public.territories (
    ...
    territory_description character varying(255),
    region_id integer NOT NULL
);


--
-- Name: territories_region_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.territories_region_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: territories_region_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.territories_region_id_seq OWNED BY public.territories.region_id;
...
--
-- Name: order_details order_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: order_details product_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: products supplier_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.products ALTER COLUMN supplier_id SET DEFAULT nextval('public.products_supplier_id_seq'::regclass);


--
-- Name: products category_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: shippers shipper_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: territories region_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.territories ALTER COLUMN region_id SET DEFAULT nextval('public.territories_region_id_seq'::regclass);
...
COPY public.employees (employee_id, last_name, first_name, title, titleofcourtesy, birth_date, hire_date, address, city, region, postal_code, country, home_phone, extension, photo, notes, reports_to, photo_path) FROM stdin;
...
--
-- Name: order_details_order_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: order_details_product_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: shippers_shipper_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: territories_region_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.territories_region_id_seq', 1, false);
...
--
-- Name: employee_territories employee_territories_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_territories employee_territories_territory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: orders orders_ship_via_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: territories territories_region_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
